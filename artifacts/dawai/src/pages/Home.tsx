...
export function Home() {
  ...
  const { data: nearbyPharmacies, isLoading: loadingPharmacies } =
    useGetNearbyPharmacies();
      ...
      <div className="flex-1 px-4 pt-5 pb-4 space-y-6 overflow-y-auto">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 no-scrollbar">
            {categories.map((cat, i) => (
              <motion.button
                ...
                onClick={() => setLocation(`/search?q=${encodeURIComponent(cat)}`)}
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-emerald-600 text-sm font-medium" data-testid="link-all-medications">
              عرض الكل
            </button>
          </div>
