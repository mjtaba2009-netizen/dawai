...
const TERMS: { title: string; body: string }[] = [
  {
    title: "١. معايير الجودة والأصالة",
    body: "يتعهد المتجر بأن جميع المنتجات المعروضة أصلية ومخزّنة وفق الشروط المعتمدة وغير منتهية الصلاحية، وبامتلاك التراخيص اللازمة لمزاولة نشاطه.",
  },
  {
    title: "٢. اتفاقية مستوى الخدمة",
    body: "يلتزم المتجر بالرد على الطلبات الواردة خلال المدة الزمنية المحددة في المنصة، وبتحديث المخزون والأسعار بشكل دقيق ومستمر لضمان تجربة موثوقة للعملاء.",
  },
  {
    title: "٣. التسعير والشفافية",
    body: "تُعرض الأسعار بالدينار العراقي شاملةً، ويُمنع فرض أي رسوم خفية على العميل. تحتفظ منصة دوائي بحق مراجعة الأسعار لضمان عدالتها.",
  },
  {
    title: "٤. خصوصية بيانات العملاء",
    body: "يتعهد المتجر بالحفاظ على سرية بيانات العملاء وطلباتهم، وعدم استخدامها لأي غرض خارج نطاق تجهيز الطلب عبر المنصة.",
  },
  {
    title: "٥. حقوق إنهاء الشراكة",
    body: "يحق لمنصة دوائي تعليق أو إنهاء حساب المتجر في حال الإخلال بأي من هذه الشروط، مع إشعار مسبق وفق السياسات المعتمدة.",
  },
];

export function PartnershipAgreementModal() {
  const { user, activateAccount } = useAuth();
  const vendorLabel = user?.role === "cosmetic" ? "متجرك" : "صيدليتك";
      ...
      >
        ...
        <div className="px-6 pt-7 pb-5 bg-gradient-to-br from-emerald-500 to-teal-600 text-white">
          ...
          <p className="text-emerald-50/90 text-xs mt-1.5 leading-relaxed">
            تم اعتماد مستندات {vendorLabel} بنجاح ✦ يُرجى مراجعة الشروط والتوقيع رقمياً لتفعيل حسابك
          </p>
        </div>
